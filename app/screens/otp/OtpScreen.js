    ...
    return (
      <View style={styles.screen}>
        ...
        <View style={styles.logoContainer}>
          <Image source={require('../../../assets/googleAuthen/googleAuthen.png')} style={styles.imgLogo}/>
          <View style={styles.titleContatiner}>
            <Text style={styles.title1}>Google Authenicator</Text>
            <Text style={styles.title2}>Input 6-digit code</Text>
          </View>
        </View>
